...
import { Box, Button, ButtonGroup, Center, Container, Image, ListItem, Select, UnorderedList } from '@chakra-ui/react'
        ...
        <Box display='flex' flexDirection='column'>
            <Center flexDirection='column' w='100%'>
                {/* <Select m={2} righticon={<ChevronDownIcon />} w='200px' onChange={handleChange} bg='#8b978f' borderColor='#8b978f' fontFamily="FF Mark W05,Arial,sans-serif">
                    {maps.map(({ value, name }) => <option key={value} value={value} bg='#8b978f'>{name}</option>)}

                </Select> */}
                <ButtonGroup color='#FFF' display='flex' justifyContent='space-around' alignItems='center' w='100%' fontFamily="FF Mark W05,Arial,sans-serif" m={0}>
